...
public interface PaymentsApi {
    ...
    default ResponseEntity<PaymentSuccessResponse> create1(@Valid @RequestBody(required = false) PaymentRequest paymentRequest) throws Exception {
    ...
    default ResponseEntity<List<Payment>> getAllPayments() {
        getRequest().ifPresent(request -> {
            for (MediaType mediaType: MediaType.parseMediaTypes(request.getHeader("Accept"))) {
                if (mediaType.isCompatibleWith(MediaType.valueOf("*/*"))) {
